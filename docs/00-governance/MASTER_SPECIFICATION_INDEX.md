...
| `EDP` | Execution & Documentation Protocol | 4 |
...
| :--- | :--- | :---: | :---: | :--- |
| **NS-001** | North Star | 0 | LOCKED | [docs/01-product/NORTH_STAR.md](../01-product/NORTH_STAR.md) |
| **CD-001** | Creative Direction | 0 | LOCKED | [docs/06-art/CREATIVE_DIRECTION.md](../06-art/CREATIVE_DIRECTION.md) |
| **AD-001** | Art Direction Bible | 0 | LOCKED | [docs/06-art/ART_DIRECTION_BIBLE.md](../06-art/ART_DIRECTION_BIBLE.md) |
| **WB-001** | World Bible | 0 | LOCKED | [docs/04-world/WORLD_BIBLE.md](../04-world/WORLD_BIBLE.md) |
| **AC-001** | Agent Constitution | 0 | LOCKED | [docs/00-governance/AGENT_CONSTITUTION.md](AGENT_CONSTITUTION.md) |
| **SR-001** | Specification Reconciliation | 0 | APPROVED | [docs/00-governance/SPECIFICATION_RECONCILIATION.md](SPECIFICATION_RECONCILIATION.md) |
| **MSI-001** | Master Specification Index & Build Governance | 0 | APPROVED | [docs/00-governance/MASTER_SPECIFICATION_INDEX.md](MASTER_SPECIFICATION_INDEX.md) |
| **FS-001** | Foundation Specification | 1 | APPROVED | [docs/01-product/FOUNDATION_SPECIFICATION.md](../01-product/FOUNDATION_SPECIFICATION.md) |
| **ETA-001** | Engine & Technical Architecture | 1 | APPROVED | [docs/02-architecture/ENGINE_TECHNICAL_ARCHITECTURE_SPECIFICATION.md](../02-architecture/ENGINE_TECHNICAL_ARCHITECTURE_SPECIFICATION.md) |
| **TA-001** | Technical Architecture (Browser/Phaser Prototype Baseline) | 1 | SUPERSEDED | [docs/02-architecture/TECHNICAL_ARCHITECTURE.md](../02-architecture/TECHNICAL_ARCHITECTURE.md) |
| **CG-001** | Core Gameplay Systems | 1 | LOCKED | [docs/03-gameplay/CORE_GAMEPLAY_SYSTEMS_SPECIFICATION.md](../03-gameplay/CORE_GAMEPLAY_SYSTEMS_SPECIFICATION.md) |
| **PC-001** | Player Control, Movement & Interaction | 1 | APPROVED | [docs/03-gameplay/PLAYER_CONTROL_MOVEMENT_INTERACTION_SPECIFICATION.md](../03-gameplay/PLAYER_CONTROL_MOVEMENT_INTERACTION_SPECIFICATION.md) |
| **WM-001** | World & Map Architecture | 1 | APPROVED | [docs/04-world/WORLD_MAP_ARCHITECTURE_SPECIFICATION.md](../04-world/WORLD_MAP_ARCHITECTURE_SPECIFICATION.md) |
| **NB-001** | Narrative Bible | 1 | DRAFT | [docs/05-narrative/NARRATIVE_BIBLE.md](../05-narrative/NARRATIVE_BIBLE.md) |
| **CB-001** | Character Bible | 1 | DRAFT | [docs/05-narrative/CHARACTER_BIBLE.md](../05-narrative/CHARACTER_BIBLE.md) |
| **BE-001** | Biome & Environment Bible | 1 | DRAFT | [docs/04-world/BIOME_ENVIRONMENT_BIBLE.md](../04-world/BIOME_ENVIRONMENT_BIBLE.md) |
| **CW-001** | Creature & Wildlife Bible | 1 | DRAFT | [docs/04-world/CREATURE_WILDLIFE_BIBLE.md](../04-world/CREATURE_WILDLIFE_BIBLE.md) |
| **ML-001** | Mystery & Lore Architecture | 1 | DRAFT | [docs/05-narrative/MYSTERY_LORE_ARCHITECTURE_SPECIFICATION.md](../05-narrative/MYSTERY_LORE_ARCHITECTURE_SPECIFICATION.md) |
| **NC-001** | Narrative Content Framework | 1 | PLANNED | Not yet drafted *(Next Creative Specification)* |
| **MI-001** | Main Island Design | 2 | DRAFT | [docs/04-world/MAIN_ISLAND_DESIGN_SPECIFICATION.md](../04-world/MAIN_ISLAND_DESIGN_SPECIFICATION.md) |
| **PI-001** | Personal Island Design | 2 | DRAFT | [docs/04-world/PERSONAL_ISLAND_DESIGN_SPECIFICATION.md](../04-world/PERSONAL_ISLAND_DESIGN_SPECIFICATION.md) |
...
| **PR-001** | Player Progression | 2 | DRAFT | [docs/03-gameplay/PLAYER_PROGRESSION_SPECIFICATION.md](../03-gameplay/PLAYER_PROGRESSION_SPECIFICATION.md) |
| **FB-001** | Farming System | 2 | DRAFT | [docs/03-gameplay/FARMING_SYSTEM_SPECIFICATION.md](../03-gameplay/FARMING_SYSTEM_SPECIFICATION.md) |
| **LA-001** | Livestock & Animal Husbandry | 2 | PLANNED | Not yet drafted |
| **HU-001** | Hunting & Combat System | 2 | DRAFT | [docs/03-gameplay/HUNTING_COMBAT_SYSTEM_SPECIFICATION.md](../03-gameplay/HUNTING_COMBAT_SYSTEM_SPECIFICATION.md) |
...
| **BI-001** | Building & Construction System | 2 | DRAFT | [docs/03-gameplay/BUILDING_CONSTRUCTION_SYSTEM_SPECIFICATION.md](../03-gameplay/BUILDING_CONSTRUCTION_SYSTEM_SPECIFICATION.md) |
...
| **MS-001** | Multiplayer & Social Systems | 2 | DRAFT | [docs/07-multiplayer/MULTIPLAYER_SOCIAL_SYSTEMS_SPECIFICATION.md](../07-multiplayer/MULTIPLAYER_SOCIAL_SYSTEMS_SPECIFICATION.md) |
...
| **IA-001** | Implementation Architecture | 4 | REVIEW | [docs/02-architecture/IMPLEMENTATION_ARCHITECTURE_SPECIFICATION.md](../02-architecture/IMPLEMENTATION_ARCHITECTURE_SPECIFICATION.md) |
| **PP-001** | Production Plan & Vertical Slice Roadmap | 4 | APPROVED | [docs/01-product/PRODUCTION_PLAN.md](../01-product/PRODUCTION_PLAN.md) |
| **QA-001** | QA & Testing Specification | 4 | PLANNED | Not yet drafted |
| **GSP-001** | GM Session Record Protocol | 4 | APPROVED | [docs/08-reports/gm/GM_SESSION_RECORD_PROTOCOL.md](../08-reports/gm/GM_SESSION_RECORD_PROTOCOL.md) |
| **EDP-001** | Execution & Documentation Protocol | 4 | APPROVED | [docs/00-governance/EXECUTION_DOCUMENTATION_PROTOCOL.md](EXECUTION_DOCUMENTATION_PROTOCOL.md) |
...
- **NS-001 — North Star V1.0:** Locked project authority established at [`docs/01-product/NORTH_STAR.md`](../01-product/NORTH_STAR.md) (defines executive definition, creative vision, Windows PC platform per SR-001, single-player-first/multiplayer-native, and immutable design principles).
- **CD-001 — Creative Direction Specification V1.0:** Canonical Creative Foundation established and locked at [`docs/06-art/CREATIVE_DIRECTION.md`](../06-art/CREATIVE_DIRECTION.md) (defines 65% Cozy / 35% Adventure balance, 50-hour feeling, slow-burn mystery, handcrafted SNES-era retro foundation + modern detail art standard, readability vs atmosphere parity, house evolution, and Creative Invariant 11: *"Never let the mystery destroy the cozy life. Never let the cozy life erase the mystery."*).
- **AD-001 — Art Direction Bible V1.0:** Canonical Art Direction Specification established and locked at [`docs/06-art/ART_DIRECTION_BIBLE.md`](../06-art/ART_DIRECTION_BIBLE.md) (defines fixed isometric perspective, no camera rotation in V1.0, 16-bit foundation with modern pixel-art execution, cozy medieval-fantasy architecture, mixed architectural age, 3-tier house evolution, tiered NPC animations, subtle mystery creature language, handcrafted UI/typography/icons, six visual signatures, and the Underhallow visual evaluation rule).
- **WB-001 — World Bible V1.0:** Canonical World-Building Foundation established and locked at [`docs/04-world/WORLD_BIBLE.md`](../04-world/WORLD_BIBLE.md) (defines island geography, town and landmarks, layered history, ancient civilization and disappearance, 8-stage emotional arc, reality-breaking places, subtle strange wildlife, grandparent inheritance, personal island sanctuary, non-forced hunting processing, and the core philosophy: *"The player comes to love Underhallow before they understand it"*).
- **AC-001 — Agent Constitution V1.0:** Development governance baseline locked at [`docs/00-governance/AGENT_CONSTITUTION.md`](AGENT_CONSTITUTION.md) (defines agent roles, domain whitelists, Definition of Done, architecture plan requirements, and code modification rules).
- **SR-001 — Specification Reconciliation V1.0:** Approved baseline established at [`docs/00-governance/SPECIFICATION_RECONCILIATION.md`](SPECIFICATION_RECONCILIATION.md) (reconciled platform to Windows PC, engine to Godot, mode to single-player-first/multiplayer-native, added Guild Islands, fixed camera orientation, and updated MSI governance).
