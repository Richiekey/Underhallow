...
- **Phase 1 — Authority:** North Star (`NS-001`), Creative Direction (`CD-001`), Agent Constitution (`AC-001`), Master Specification Index (`MSI-001`), Specification Reconciliation (`SR-001`).
